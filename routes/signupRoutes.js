...
router.post("/logout", signupController.logout)
router.get("/fetchoneuserdata/:useremail", verifyjsontoken, signupController.fetchoneuserdata)
router.get("/fetchallusers", verifyjsontoken, verifyadmin, signupController.fetchallusers)
